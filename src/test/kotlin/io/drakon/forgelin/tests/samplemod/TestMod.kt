package io.drakon.forgelin.tests.samplemod
...
@Mod(modid = "Forgelin|Test", name = "Forgelin Test Mod", modLanguage = "kotlin", modLanguageAdapter = "io.drakon.forgelin.KotlinAdapter")
object TestMod {
